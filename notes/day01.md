# Day 01 - 31 Mordad 1405 / 22 August 2026
...
#### 1.Variable
Persian : ظرفی در حافظه که داده ها و مقادیر رو در خودش نگه داری میکنه.

English : A variable is a container in memory that stores data or valus.
...
#### ​2.What is GitHub?
​Persian : گیت‌ هاب یک وبسایت برای ذخیره و مدیریت پروژه‌ های گیت آنلاین است.
...
#### ​1.What is Linux?
​Persian : لینوکس یک سیستم‌ عامل قدرتمند و متنباز (Open-Source) است.
